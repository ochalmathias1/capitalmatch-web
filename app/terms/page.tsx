      ...
      <main style={{ paddingTop: '72px', backgroundColor: '#FFFFFF' }}>
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', padding: '4rem 1.5rem' }}>
          <div style={{ fontFamily: 'var(--font-ibm, sans-serif)', color: '#374151', lineHeight: 1.8, fontSize: '0.95rem' }}>
            ...
            {[
              {
                title: '1. No Broker Fees to Applicant',
              ...
              {
                title: '8. Third-Party Lender Agreements',
              ...
              {
                title: '12. Contact Us',
                content: `Questions about these Terms should be directed to: CapitalMatch, legal@capitalmatchfunding.com. For general inquiries: lenders@capitalmatchfunding.com.`,
              },
            ].map(({ title, content }) => (
