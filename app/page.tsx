...
export const metadata: Metadata = {
  ...
  description: 'One application reaches 40+ private lenders. Zero broker fees. All industries welcome. Bad credit options available. Get your merchant cash advance in 24 hours. Apply free today.',
  alternates: { canonical: 'https://capitalmatchfunding.com' },
  openGraph: {
    title: 'Business Funding in 24 Hours | No Broker Fees | CapitalMatch',
    description: 'One application reaches 40+ private lenders. Zero broker fees. All industries welcome. Bad credit options available. Apply free today.',
  ...
  twitter: {
    title: 'Business Funding in 24 Hours | No Broker Fees | CapitalMatch',
    description: 'One application reaches 40+ private lenders. Zero broker fees. All industries welcome. Bad credit options available.',
...
const organizationSchema = {
  ...
  name: 'CapitalMatch',
  url: 'https://capitalmatchfunding.com',
  description: 'CapitalMatch is a commercial finance broker providing fast merchant cash advance funding with zero broker fees. One application reaches 40+ private lenders.',
  email: 'support@capitalmatchfunding.com',
        ...
        <section style={{ backgroundColor: '#F8F4ED', padding: '3rem 1.5rem', borderTop: '1px solid #E5E7EB' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'center' }}>
            <p style={{
              ...
              our network of 40+ private lenders can help. We specialize in fast business funding for restaurants,
